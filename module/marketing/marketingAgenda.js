...
let scheduleMarketingAgenda = async (schedule, job, data) => {
    try {
        // console.log("scheduleMarketingAgenda", job);
        agenda.schedule(schedule, job, data);
    } catch (error) {
        console.log("scheduleMarketingAgenda error", error);
    }
};

module.exports = {
    scheduleMarketingAgenda
};