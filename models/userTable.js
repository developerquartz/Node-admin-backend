    ...
    return User.aggregate(
        [
            ...
            },
            {
                ...
                {
                    from: "products",
                    let: { productId: "$serviceId", ...data.availability },
                    pipeline: [
                        {
                            $match:
                            {
                                $expr:
                                {
                                    $and:
                                        [
                                            ...
                                            { $eq: ["$availability.guest", "$$guest"] },
                                            { $eq: ["$availability.beds", "$$beds"] },
                                            { $eq: ["$availability.bedrooms", "$$bedrooms"] },
                                            { $eq: ["$availability.bathrooms", "$$bathrooms"] },
