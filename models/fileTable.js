...
let fileSchema = mongoose.Schema({
    productId: { type: mongoose.Schema.Types.ObjectId, ref: "Product" }, // dont remove/hide this field
    vendor: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, // dont remove/hide this field
    storeType: { type: mongoose.Schema.Types.ObjectId, ref: "storeType" }, // dont remove/hide this field
   
    store: { type: mongoose.Schema.Types.ObjectId, ref: "Store" }, // dont remove/hide this field
